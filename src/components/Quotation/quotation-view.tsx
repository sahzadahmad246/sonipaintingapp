...
export default function QuotationView({ quotationNumber }: QuotationViewProps) {
  ...
  useEffect(() => {
    ...
    fetchQuotation();
  }, [quotationNumber, fetchQuotation, status]);
              ...
              <div className="md:col-span-5 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 px-4 py-3 border-b border-gray-200">
                  <h3 className="font-medium text-gray-800 flex items-center">
                    <User className="h-4 w-4 text-blue-600 mr-2" /> Client
                    Information
                  </h3>
                </div>
                <div className="p-5">
                ...
                <Card className="overflow-hidden border shadow-md">
                  <CardHeader className="bg-white border-b py-4">
                    <CardTitle className="flex items-center text-lg text-gray-800">
                      <ImageIcon className="h-5 w-5 mr-2 text-primary" /> Site
                      Images
                    </CardTitle>
                    <CardDescription>
                    ...
                    {quotation.siteImages?.length ? (
                      ...
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-gray-500 mb-2">
                          No site images available for this quotation.
                        </p>
                        {session?.user?.role === "admin" && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-2">
                    <Card className="overflow-hidden border shadow-md h-full">
                      <CardHeader className="bg-white border-b py-4">
                        <CardTitle className="flex items-center text-lg text-gray-800">
                          <Tag className="h-5 w-5 mr-2 text-primary" /> Terms &
                          Conditions
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="p-6">
                        {quotation.terms?.length ? (
                          ...
                          <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-gray-500">
                              No terms specified for this quotation.
                            </p>
                          </div>
                        )}
                      </CardContent>
          ...
          <div className="hidden print:block mt-6">
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="text-right">
                ...
                <p className="text-sm">
                  +91 9876543210 | contact@sonypainting.com
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 pt-4 border-t text-center text-xs text-gray-500">
              ...
              <p className="mt-1">
                For any queries, please contact us at +91 9876543210 or
                contact@sonypainting.com
              </p>
            </div>
          </div>
