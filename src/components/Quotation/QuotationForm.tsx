        ...
        <Tabs defaultValue="client" value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            ...
                            <Input {...field} id="clientName" placeholder="Enter client name" className="h-10 pl-10" />
                          </div>
                        )}
                      />
                        ...
                        render={({ field }) => (
                          <div className="relative">
                            ...
                            <Textarea
                              ...
                              rows={4}
                              value={field.value ?? ""}
                              className="mt-1 resize-none pl-10"
                            />
                          </div>
                        )}
                      />
            ...
            <CardFooter className="flex justify-between bg-gray-50 border-t p-6">
              ...
              >
                {activeTab === "client" ? "Cancel" : "Previous"}
              </Button>
              <div className="flex gap-2">
                {activeTab !== "terms" ? (
                  ...
                  <Button type="submit" disabled={isSubmitting} className="bg-primary/90 hover:bg-primary" size="lg">
